...
const int THEROCK_EVALUATOR_SEARCH_WIN_POTENTIAL_MULTIPLIER = 10000;
const int THEROCK_EVALUATOR_SEARCH_WIN_MULTIPLIER = 200000;
const int THEROCK_EVALUATOR_SEARCH_LOSE_MULTIPLIER = -200000;
const int THEROCK_EVALUATOR_FREE_WINPOINT_MULTIPLIER = 100;
const int THEROCK_EVALUATOR_WHITE_WINPOINT_MULTIPLIER = 200;
